...
import { fetchFilterSettings, fetchFilterSettings_filterSettings } from "~@/graphql/generated/fetchFilterSettings";
...
const fetchFilterSetting = async () => {
    const {
        data: { filterSettings, ignoredSkills }
...
const filterBags = async (projects: IFLProject[], settings: IprojectFilter, ...args) => {
